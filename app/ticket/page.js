            ...
            <div>
              ...
              <div className="flex text-[20px]">
                <ul className={`flex-[3] hover:[&>*]:bg-[#a82726] hover:[&>*]:text-white flex items-start flex-col`}>
                  <li className="flex"><Link href={'https://github.com/amansxcalibur'} className="w-full h-full">Abhinav M</Link></li>
                  <li className="flex"><Link href={'https://github.com/itsabhinavm'} className="w-full h-full">Aman V Shafeeq</Link></li>
